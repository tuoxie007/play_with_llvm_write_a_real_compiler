...
static void InitializeModuleAndPassManager() {
    // Open a new module.
    TheModule = make_unique<Module>("Sisp Demo 08", TheContext);
...
//    cout << StdContent;
    ...
    FILE *TestFile = fopen("/Users/xuke/mywork/play_with_llvm/sisp/sisp/test08.sisp", "r");
